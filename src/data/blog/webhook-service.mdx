...
title: Webhook Service | How To Approach System Design Interview + Practical Example category
draft: false
...
- [Design a Webhook Service #2](https://systemdesignschool.io/problems/webhook/solution)
